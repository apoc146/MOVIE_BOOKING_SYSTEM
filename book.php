...
//						echo "You will be automatically redirected after 5 seconds.";
			...
			?> 
			<form name="contactForm" action="booking_registeration.php" method="POST" class="form-horizontal">
				<div class='control-group'>
					...
					<?php
						if(isset($_POST['doj']))
						{
							...
							echo "<label class='control-label' for='input1'>Date Of Booking</label>";
	            ...
	            ?>
	            	...
	            	<div class="control-group">
	                <label class="control-label" for="input1">Movie ID</label>
	                <div class="controls">
	                    <input type="text" name="user_name" id="input1" placeholder="displays movie id" class="span3" title="Please enter a valid name." value=<?php 
	                    echo $mid;
	                    ?>
	            ...
	            <div class="control-group">
	                ...
	                <div class="controls">
	                    <input type="text" class="span3" placeholder="Type your user id" name="userid" pattern="[A-z ]{3,}" title="Please enter a valid username." value=<?php echo $userid?> readonly/>
	                </div>
	            </div>
