...
<?php
 //include('db_login.php');
	...
	mysqli_select_db($connection,'first_bd');
	if(isset($_POST["movie_id"])){
		$movie_id=$_POST["movie_id"];
		echo "movie_id assigned";
	}
	else{
		echo "movie_id not assigned";
	}
	$m_id=mysqli_real_escape_string($connection,$_POST["movie_id"]);
			...
			<div class="row well">
				<div class="span10">
					<form action="seat.php" method="POST">
						<center>
							<label>Date Of Movie Booking</label>
