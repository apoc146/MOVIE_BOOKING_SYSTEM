...
mysqli_select_db($connection,'first_db');
...
if (isset($error)) {
    header('Location: book.php?e='.urlencode($error)); 
    exit;
}
...
// Success
$query = "INSERT INTO register (userid, name, email, password, address, contact, message, movieid) VALUES ('" . $userid . "','" . $name . "','" . $email . "','" . $password . "','" . $address . "','" . $mobile . "','" . $message . "','" . $mid . "')";
...
if (!$results)
{
	die ("Could not insert to the register: <br />". mysqli_error());
}
